...
public class Tester {
	public static void main(String[] args) throws IOException {
		Alignment a = new Local(new SequencePair("MAUS", "SUMA", "SeqA", "SeqB"), new GapFunction(0, -1), new ScoringMatrix("/home/proj/biocluster/praktikum/bioprakt/Data/MATRICES/blosum62.mat"));
		a.make();
